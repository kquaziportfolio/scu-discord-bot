...
module.exports = {
	...
	async execute (client, message, args) {
		...
		`**NOTE**: If you are a <@&${client.config.serverRoles.prospectiveStudent}>, please contact <@&${client.config.serverRoles.admin}> or <@&${client.config.serverRoles.mod}> to give you roles as the form is for SCU domain users! Thank you for your cooperation! 😊`
		)
