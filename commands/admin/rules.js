    ...
    usage: `${prefix}rules`,
		async execute(message, args) { 
            if ((message.member.roles.cache.has('710593727864897646', '709118762707845211'))) {
                ...
                `${emojiCharacters.one}${emojiCharacters.three} Contact an <@&709118762707845211> or <@&710593727864897646> before advertising anything.\n\n` +
                ...
                const embed = new new MessageEmbed()
                .setColor(10231598)
