...
module.exports = {
    ...
    usage: `global / ${config.prefix}covid19 [state abbreviation] / ${config.prefix}covid19 county`, 
        async execute (message, args) {
            ...
            COVID_EMBED2.addField(`On Ventilator Currently`, `${data2.onVentilatorCurrently || 'no data found'}`, true)
            COVID_EMBED2.addField(`Recovered: `, `${data2.recovered || 'no data found'}`, true)
            COVID_EMBED2.addField(`Deaths: `, `${data2.death}`, true)
            COVID_EMBED2.addField(`Hospitalized: `, `${data2.hospitalized || 'no data found'}`, true)
